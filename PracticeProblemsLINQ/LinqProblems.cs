...
namespace PracticeProblemsLINQ
{
    public static class LinqProblems
    {
        ...
        {
            //code          
            var nameMike = customers.Single(m => m.FirstName.Contains("Mike"));
            return nameMike;
        }
        #endregion
        ...
        {
            //code
            var id3 = customers.ElementAtOrDefault(2);
            id3.FirstName = "Robert";
            id3.LastName = "Downey Jr";
            //return
            return id3;
        }
        #endregion
